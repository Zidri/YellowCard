  ...
  return (
    <div className="homegrid">
      <div className="homebox">
        ...
        <p className="deets1m">
          A fast, all-in-one PDF tool that lets you<br />
          convert to Word. Merge files, and split <br />
          pdf documents effortlessly in a clean, <br />
          user-friendly interface.
        </p>

        <p className="deets2m">
          Image resizer feature that lets you quickly<br />
          adjust dimensions and optimize images <br />
          with ease.
        </p>
      </div>
